                ...
                <div className="w-[80%] h-[80%]">
                    ...
                    <div>
                        <div className="mb-2">
                            ...
                            <input className="p-1 border-1 w-full rounded-[.3em]" type="text" id="name" placeholder="Nome" />
                        </div>
                        <div className="mb-2">
                            <label className="block mb-1" htmlFor="lastname">Sobrenome:</label>
                            <input className="p-1 border-1 w-full rounded-[.3em]" type="text" id="lastname" placeholder="Sobrenome" />
                        </div>
                        <div className="mb-2">
                    ...
                    <div>
                        <button className="text-[#FFFFFF] py-1 w-full bg-[#ED5684] rounded-[.3em] my-2">CADASTRAR</button>
                    </div>
